    ...
    <>
      ...
      >
        ...
        <div className="mt-8 text-center space-y-3">
          <h2
            className={`text-2xl font-black uppercase tracking-wider ${textColor} italic`}
          >
            {message}
          </h2>
          <p
            className={`text-xs font-mono uppercase tracking-[0.2em] ${textMutedColor}`}
          >
        ...
        <div
          className={`mt-12 w-32 h-1 rounded-full overflow-hidden border ${isDark ? "bg-white/10 border-[#A3FF00]/30" : "bg-black/10 border-black/30"}`}
        >
          <div
        ...
        <div className="mt-8 text-center">
          <p
            className={`text-[10px] font-black uppercase tracking-[0.3em] ${isDark ? "text-white/40" : "text-black/40"}`}
          >
