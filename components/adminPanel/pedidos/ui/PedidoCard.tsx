...
export function PedidoCard({ pedido }: PedidoCardProps) {
  ...
  // Paleta indexada estricta adaptada a la estética Neo-Brutalista
  ...
  return (
    <div className="bg-white dark:bg-bg-darker border-2 border-border dark:border-border-dark rounded-super overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-all animate-in fade-in zoom-in-95 font-sans">
      ...
      >
        ...
        <div className="text-right">
          ...
          <p className="font-black text-xl italic tracking-tighter font-mono">
            $
      ...
      <div className="p-5 space-y-4 flex-1">
        ...
        <div className="pt-4 border-t-2 border-dashed border-border dark:border-border-dark space-y-3">
      ...
      <div className="p-4 bg-gray-50 dark:bg-white/5 border-t-2 border-border dark:border-border-dark grid grid-cols-2 gap-2">
        {/* Estado 1: Pendiente */}
        ...
        {/* Estado 3: En viaje (Solo para envíos a domicilio) */}
